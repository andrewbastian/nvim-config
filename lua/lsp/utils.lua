...
function M.common_on_attach(client, bufnr)
  ...
  -- Trouble
bufnnoremap( "<leader>xx", "<cmd>TroubleToggle<cr>",
  {silent = true, noremap = true}
)
bufnnoremap( "<leader>xw", "<cmd>TroubleToggle workspace_diagnostics<cr>",
  {silent = true, noremap = true}
)
bufnnoremap( "<leader>xd", "<cmd>TroubleToggle document_diagnostics<cr>",
  {silent = true, noremap = true}
)
bufnnoremap( "<leader>xl", "<cmd>TroubleToggle loclist<cr>",
  {silent = true, noremap = true}
)
bufnnoremap( "<leader>xq", "<cmd>TroubleToggle quickfix<cr>",
  {silent = true, noremap = true}
)
bufnnoremap( "gR", "<cmd>TroubleToggle lsp_references<cr>",
  {silent = true, noremap = true}
)
